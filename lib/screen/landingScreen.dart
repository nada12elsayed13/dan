...
class LandingScreen extends StatelessWidget {
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Flexible(
                    child: Text(
                      "Discover the best foods from over 3,000 restaurants",
  ...
  clipShadow({required CustomClipperAppBar clipper, required List<BoxShadow> boxShadow, required Container child}) {}
}
